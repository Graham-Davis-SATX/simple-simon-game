...
bgMusicObj.src = 'audio/roundMusic.mp3';
    ...
    function listen() {
        ...
        $("#a, #b, #c, #d").on("mousedown", function() {
            ...
            if (this.id == settings.sequence[settings.clicked]) {
                ...
                $("#tune").attr("src", "audio/gameOver.mp3");
                audio[0].pause();
                audio[0].load();
                audio[0].play();
